...
FAMILY_RULES: list[tuple[str, str]] = [
    ...
    ("operational risk",           "Gestion des risques"),
    ("quantitative risk",          "Gestion des risques"),
    ("risk management",            "Gestion des risques"),
    ("risk analyst",               "Gestion des risques"),
    ("risk",                       "Gestion des risques"),
    # Finance / Compta
    ("accounting",                 "Finance / Comptabilité"),
    ("financial reporting",        "Finance / Comptabilité"),
    ("regulatory reporting",       "Finance / Comptabilité"),
    ("tax",                        "Finance / Comptabilité"),
    ("treasury",                   "Finance / Comptabilité"),
    ("controller",                 "Finance / Comptabilité"),
    ...
    ("trade support",              "Opérations / Back Office"),
    ("transaction banking",        "Opérations / Back Office"),
    ("cash management",            "Opérations / Back Office"),
    ("custody",                    "Opérations / Back Office"),
    ("transfer agent",             "Opérations / Back Office"),
    ("client service",             "Opérations / Back Office"),
    # RH
    ...
    ("chief of staff",             "Stratégie / Management"),
    ("program manager",            "Stratégie / Management"),
    ("project manager",            "Stratégie / Management"),
    ("business analyst",           "Stratégie / Management"),
    # Marchés financiers
    ...
    ("equity research",            "Marchés financiers / Sales & Trading"),
    ...
    ("research analyst",           "Marchés financiers / Sales & Trading"),
    ...
    # Banque de détail / Private Banking
    ("wealth management",          "Banque Privée & Wealth Management"),
    ("merrill",                    "Banque Privée & Wealth Management"),
    ("private bank",               "Banque Privée & Wealth Management"),
    ("financial advisor",          "Banque Privée & Wealth Management"),
    ("financial solutions advisor","Banque Privée & Wealth Management"),
    ("banker",                     "Banque Privée & Wealth Management"),
    ("relationship manager",       "Commercial & Relations Clients"),
    ("relationship banker",        "Commercial & Relations Clients"),
    ("commercial banking",         "Commercial & Relations Clients"),
    ("business banking",           "Commercial & Relations Clients"),
    ("retail",                     "Banque de détail"),
    ("branch",                     "Banque de détail"),
    ("teller",                     "Banque de détail"),
]
