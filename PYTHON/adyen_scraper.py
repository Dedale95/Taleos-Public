...
Adyen — Job Scraper
=====================
Source : Greenhouse API publique (board "adyen")
...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(sys.stdout),
              logging.FileHandler("adyen_scraper.log", encoding="utf-8")],
)
...
DB_PATH      = Path(__file__).parent / "adyen_jobs.db"
REQUEST_PAUSE = 0.2
...
def init_db(conn: sqlite3.Connection):
    ...
    CREATE TABLE IF NOT EXISTS jobs (
        ...
        company_name     TEXT DEFAULT 'Adyen',
